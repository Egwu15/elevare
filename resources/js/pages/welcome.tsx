    ...
    return (
        <>
            ...
            <header className="mx-auto w-full bg-black py-6 text-sm">
                <nav className="mx-auto mt-4 flex items-center justify-between px-5 md:px-0 lg:max-w-6xl">
                    <AppLogoIcon />
            ...
            <main className="w-full opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                <section className="w-full bg-black px-5 md:px-0">
                    <section className="mx-auto w-full max-w-7xl items-center justify-between py-14 text-white md:flex">
                        <div className="max-w-lg">
                            ...
                            <Button className="bg-green-500 hover:bg-green-400">Start Learning</Button>
                        </div>
                ...
                <section>
                    <div className="my-20 w-full grid-cols-3 bg-white p-5 md:grid md:p-20">
                        <p className="text-4xl md:text-5xl">
                            Online Learning <br /> <span className="text-green-500">Designed for</span> <br />{' '}
                            <span className="text-green-500">Professionals</span>
                        </p>
                        <div className="mx-0 mt-8 md:mt-0">
                            <div>
                            ...
                            <div>
                                ...
                                <p className="mb-3 text-xl md:mb-0">
                                    Customized programs that align with your aspirations—whether you're climbing the corporate ladder or leading your
                                    own venture.
                                </p>
                            </div>
                        </div>
                        <div className="md:pl-2">
                            ...
                            <div>
                                ...
                                <p className="mb-3 text-xl md:mb-0">Learn alongside a diverse community of professionals from around the world.</p>
                            </div>
                        </div>
                    </div>
                </section>
                <section className="mx-auto w-full max-w-7xl px-5 md:px-0">
                    <div className="mx-4 text-center">
                        ...
                        <p className="mx-auto mt-5 max-w-lg text-xl">
                            Each program run for 12 weeks and is designed by top industry experts to ensure you gain the skills that matter most in
                ...
                <section className="my-36 bg-[#EAF0ED]">
                    <div className="mx-auto w-full max-w-7xl px-5 py-32 md:px-0">
                        <div className="mb-14">
                            ...
                            <p className="mt-5 max-w-sm text-xl">Elevare Academy offers a dynamic learning experience that fits your schedule.</p>
                        </div>
                ...
                <section className="w-full">
                    ...
                    <div className="mx-5 mt-20 mb-32 max-w-7xl grid-cols-3 gap-3 md:mx-auto md:grid">
                ...
                <section className="mx-auto bg-black px-5 py-32 text-center text-white">
                    <div>
                    ...
                    <div>
                        <p className="mb-4 text-4xl font-medium">Have questions?</p>
                        <p className="mx-auto text-center text-3xl">Reach out to us at info@elevareacademy.com</p>
                        <p className="mx-auto mt-6 text-center text-xl text-white/40">
